...
export const furnitureMetadata = {
    ...
    'f201': { name: 'HoloLines-01', hasCollision: true, info: "A flickering holographic projection. // Purely decorative, it adds a touch of high-tech ambiance to the sterile lab environment." },
    'f202': { name: 'HoloLines-02', hasCollision: true, info: "A flickering holographic projection. // Purely decorative, it adds a touch of high-tech ambiance to the sterile lab environment." },
