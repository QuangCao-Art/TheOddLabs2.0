export const MONSTERS = {
    ...
    lydrosome: {
        ...
        type: 'OSMOTIC',
        archetype: 'TACTICIAN',
        lore: 'A high-enzyme lysosome modified for long-range secretion. It uses chemical lances to dissolve enemy membranes from a safe tactical distance.\n\nTACTICS: Extreme glass-cannon. High Critical chance and Attack make it deadly, but its low HP and Defense make it vulnerable if accurately predicted.',
        hp: 85,
        maxHp: 85,
        pp: 1,
        maxPp: 10,
