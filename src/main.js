...
window.ITEM_PICKUP_DATA = {
    ...
    // Key Items
    'Quest01': { name: 'Old Keycard', desc: 'An old but still function key card.', spriteClass: 'f50', type: 'item', previewImg: 'Card_Placeholder.png' },
    'Quest02': { name: 'Inferno Sauce Bottle', desc: 'A bottle of Inferno Brand super chili sauce.', spriteClass: 'f51', type: 'item', previewImg: 'Card_Placeholder.png' },
    ...
    'SSCARD01': { name: 'Ultimate Rare Card', desc: 'A data card with super rare custom image on it.', spriteClass: 'f63', type: 'item', previewImg: 'Card_Placeholder.png' },
    'SSCARD02': { name: 'Ultimate Rare Card', desc: 'A data card with super rare custom image on it.', spriteClass: 'f63', type: 'item', previewImg: 'Card_Placeholder.png' },
    'SSCARD03': { name: 'Ultimate Rare Card', desc: 'A data card with super rare custom image on it.', spriteClass: 'f63', type: 'item', previewImg: 'Card_Placeholder.png' },
    'CARD00': { name: 'Collectible Cards: Stemmy', desc: 'A collectible card features Stemmy, hand made by Jenzi.', spriteClass: 'f75', type: 'item', previewImg: 'Card_Stemmy.png' },
    'CARD01': { name: 'Collectible Cards: Cambihil', desc: 'A collectible card features Cambihil, hand made by Jenzi.', spriteClass: 'f75', type: 'item', previewImg: 'Card_Cambihil.png' },
    ...
    'blueprint_lydrosome': { name: 'Cell Blueprint', desc: 'A blueprint to create Lydrosome.', spriteClass: 'f101', type: 'blueprint', previewImg: 'Card_Placeholder.png' },
    // --- Unified Hidden Rewards ---
    'REWARD_BLUEPRINT_STEMMY': { name: 'Cell Blueprint', desc: 'A blueprint to create Stemmy.', spriteClass: 'f101', type: 'blueprint' },
    'REWARD_BLUEPRINT_NITROPHIL': { name: 'Cell Blueprint', desc: 'A blueprint to create Nitrophil.', spriteClass: 'f101', type: 'blueprint' },
    'REWARD_BLUEPRINT_CAMBIHIL': { name: 'Cell Blueprint', desc: 'A blueprint to create Cambihil.', spriteClass: 'f101', type: 'blueprint' },
    'REWARD_BLUEPRINT_LYDROSOME': { name: 'Cell Blueprint', desc: 'A blueprint to create Lydrosome.', spriteClass: 'f101', type: 'blueprint' },
    'REWARD_CREDITS_50': { name: 'Lab Credit Chip', desc: 'A small cache of 50 Lab Credits.', type: 'resource', resourceType: 'credits', amount: 50, spriteClass: 'f104' },
    'REWARD_CREDITS_10': { name: 'Lab Credit Chip', desc: 'A tiny cache of 10 Lab Credits.', type: 'resource', resourceType: 'credits', amount: 10, spriteClass: 'f104' },
    'REWARD_CREDITS_100': { name: 'Lab Credit Chip', desc: 'A secure cache of 100 Lab Credits.', type: 'resource', resourceType: 'credits', amount: 100, spriteClass: 'f104' },
    'REWARD_CREDITS_250': { name: 'Lab Credit Chip', desc: 'An executive cache of 250 Lab Credits.', type: 'resource', resourceType: 'credits', amount: 250, spriteClass: 'f104' },
    'REWARD_BIOMASS_20': { name: 'Biomass Container', desc: 'A small container of 20 raw Biomass.', type: 'resource', resourceType: 'biomass', amount: 20, spriteClass: 'f102' },
    'REWARD_BIOMASS_50': { name: 'Biomass Container', desc: 'A bulk container of 50 raw Biomass.', type: 'resource', resourceType: 'biomass', amount: 50, spriteClass: 'f102' },
    'REWARD_BIOMASS_100': { name: 'Biomass Container', desc: 'A major container of 100 raw Biomass.', type: 'resource', resourceType: 'biomass', amount: 100, spriteClass: 'f102' },
    'REWARD_CARD_STEMMY': { name: 'Collectible Cards: Stemmy', desc: 'A collectible card features Stemmy.', spriteClass: 'f75', type: 'card' },
